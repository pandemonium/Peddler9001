...
object Domain {
  ...
  trait TransactionsAspect extends Structure { self: PersistentUniverse with CustomersAspect ⇒
    import profile.simple._, TransactionType._
  ...
  trait DepositsAspect extends Structure { self: PersistentUniverse with TransactionsAspect ⇒
    import profile.simple._
  ...
  trait OrdersAspect extends Structure {
    ...
    import profile.simple._, OrderStatus._
...
object Program extends App {
  ...
  val database = Database forURL (
        ...
        driver = "com.mysql.jdbc.Driver",
          user = "root",
      password = "")
  val universe = new Domain.UnifiedPersistence(slick.driver.MySQLDriver)
